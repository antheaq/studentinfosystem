...
?>
    ...
    <head>
        <title>Student - Home - LA University Student Information System</title>
        <meta charset="utf-8">
            ...
            <nav class="navbar navbar-expand-lg navbar-dark navbar-dash">
                <span class="navbar-text mr-3">
                    <h5>Welcome,
                        ...
                        <?php
                        echo "<a href='student_dashboard.php'>" . $_SESSION['email'] . "</a>!";
                        ?>
                ...
                <div class="collapse navbar-collapse" id="navbarText">
                    ...
                    <span class="navbar-text mr-3">
                        <a href="student_dashboard.php?student_logout='1'">
                    ...
                    <div class="col-lg-12 my-5">
                        <div class="card">
                            <div class="card-body justify-content-center text-center">
                                <h4 class="card-title text-center py-4">My Student Profile</h4>
                                ...
                                $result = $mysqli->query("SELECT * FROM student WHERE email = '" . $_SESSION['email'] . "' AND password = '" . $_SESSION['password'] . "'") or die($mysqli->error);
                                ...
                                <div class="pt-3">
                                <a href="student_profile_edit.php?edit=<?php echo $row['student_id']; ?>" class="btn btn-lg btn-info">Edit</a>
                                </div>
                            </div>
                        </div>
                    </div>
