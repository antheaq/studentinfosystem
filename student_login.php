        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 mx-auto">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title text-center py-3">Sign in as Student</h4>
                            <form id="studentLoginForm" action="functions.php" method="POST">
                                ...
                                <div class="form-group">
                                    <i class="fa fa-envelope icon-student"></i>
                                    <input type="email" class="form-control" id="email" name="email" placeholder="Enter email" required>
                                </div>

                                <div class="form-group">
                                    <i class="fa fa-lock icon-student"></i>
                                    <input type="password" class="form-control" id="password" name="password" placeholder="Password" required>
                                </div>

                                <div class="text-right mb-3">
                                    <button type="submit" class="btn btn-success btn-lg" name="studentLoginBtn">Login</button>
                                </div>

                                <div class="row">
                                    <div class="col-lg-6">
                                        <p class="text-left"><a href="admin_login.php"> Sign in as Admin</a></p>
                                    </div>
                                    <div class="col-lg-6 text-right">
                                        <p> No account yet? <a href="student_registration.php">Sign up</a></p>
                                    </div>
                                </div>
                            </form>
                        </div>
