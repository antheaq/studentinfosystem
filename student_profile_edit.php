            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 mx-auto">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title text-center pt-4 mb-5">Edit Your Student Details</h4>
                                <form id="studentUpdateForm" action="functions.php" method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 mb-3 text-right">
                                            <button type="submit" class="btn btn-success btn-lg" name="studentUpdateBtn">Update</button>
                                        </div>
                                    </div>
