        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 mx-auto">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title text-center py-3">Create Admin Account</h4>
                            <form id="adminSignupForm" action="functions.php" method="POST">
                                ...
                                <div class="form-group">
                                    <label for="signupForm-lname">Email</label>
                                ...
                                <div class="text-right mb-3">
                                    <button type="submit" class="btn btn-success btn-lg" name="adminSignupBtn">Submit</button>
                                </div>
